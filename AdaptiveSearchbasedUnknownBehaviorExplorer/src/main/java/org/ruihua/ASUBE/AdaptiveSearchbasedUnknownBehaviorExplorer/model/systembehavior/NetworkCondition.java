...
public class NetworkCondition {
	...
	public NetworkCondition(double dataflow_loss_percentage, double dataflow_delay_time,
	 ...
	 * */
	public static NetworkCondition deltaNetworkEnvironment( NetworkCondition ne_source,
			NetworkCondition ne_target){
		NetworkCondition delta = new NetworkCondition();
