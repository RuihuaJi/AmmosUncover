...
public class Experiment_AMMOSUNCOVER_MOSA_SysApp_Appium_Executor {
	...
	public Experiment_AMMOSUNCOVER_MOSA_SysApp_Appium_Executor(ASUBERunner saRC, int[] objs, String refPF, int TCsNum, int tryPLoopNum, int tryTCycleNum, String eLFF, String oSMF, String oTCF, String reTCF, String upSMF, String reDSObF, String testIRLabel, String eTCsinRVsF, String eTCsinFVsF, String aPFswithObjsF) {
		System.out.println("==================== Experiment_AMMOSUNCOVER_MOSA_SysApp_Appium_Executor() (all parameters) ====================");
	...
	public Experiment_AMMOSUNCOVER_MOSA_SysApp_Appium_Executor(ASUBERunner saRC, String refPF, int TCsNum, int tryPLoopNum, int tryTCycleNum, String eLFF, int maxiExecutedTestCasesNum, int maxiTrialProcessLoopNum) {
		System.out.println("==================== Experiment_AMMOSUNCOVER_MOSA_SysApp_Appium_Executor() (less parameters) ====================");
	...
	public static void main(String[] args) throws Exception {
		...
		Experiment_AMMOSUNCOVER_MOSA_SysApp_Appium_Executor ex = new Experiment_AMMOSUNCOVER_MOSA_SysApp_Appium_Executor(
//				new NSGAII_ASUBERunner(),//implemented MOSA instances, NSGA-II
//				new MOCell_ASUBERunner(),//MOCell
//				new NSGAIII_ASUBERunner(),//NSGA-III
//				new SPEA2_ASUBERunner(),//SPEA2
				new CellDE_ASUBERunner(),//CellDE
				"", //referenceParetoFront is not need during AmmosUncover process
				15,//Number of Test Cases per test cycle, e.g., 5 or 10 or 15
				2,//the index of trials (We conduct each configuration for many trails)
				7,//the index of test cycle. It should start from 1th test cycle; or we need to manually create the file folder, the original state machine file (02), and the original possibly-existing system execution repository file (03).
				"InputOutputFiles/", //Experiment Label for the File Folder
				120, //the maximum of Executable Test Cases, in AmmosUncover, we set 120.
				10 //the maximum of trials (at least 10 for the randomness of this experiment)
				);
