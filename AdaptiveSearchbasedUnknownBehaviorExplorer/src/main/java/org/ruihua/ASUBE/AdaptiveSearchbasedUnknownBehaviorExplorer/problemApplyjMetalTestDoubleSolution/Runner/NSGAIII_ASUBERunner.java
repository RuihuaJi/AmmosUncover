...
public class NSGAIII_ASUBERunner extends ASUBERunner {

	public final String algName = "NSGA-III";
	
	//20200202_To use the output in the experiment process.
	public NSGAIII_ASUBERunner() {
	...
	public void run(String problemClassName, int[] objs, String pName, String statemachinefile, String realbehaviorsfile, String referenceParetoFront) {
	    ...
	    algorithm = new NSGAIIIBuilder<DoubleSolution>(problem).setCrossoverOperator(crossover).setMutationOperator(mutation)
	    		.setSelectionOperator(selection).setMaxIterations(2500).build();
	...
	public static void main(String[] args) {
		...
		//int[] o = {1, 1, 1, 1};
		//NSGAIII_ASUBERunner nsgaiii = new NSGAIII_ASUBERunner();
		//nsgaiii.run(o, "NSGAIII_Problem", "InputOutputFiles-201903-02/06StateMachine-1.0.txt", "InputOutputFiles-201903-02/05BehaviourPairs-2.0.txt", "");
