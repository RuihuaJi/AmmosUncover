...
public class MOCell_ASUBERunner extends ASUBERunner {

	public final String algName = "MOCell";
	
	//20200202_To use the output in the experiment process.
	public MOCell_ASUBERunner() {
	...
	public void run(String problemClassName, int[] objs, String pName, String statemachinefile, String realbehaviorsfile, String referenceParetoFront) {
		...
		algorithm = new MOCellBuilder<DoubleSolution>(problem, crossover, mutation).setSelectionOperator(selection)
				.setMaxEvaluations(2500).setPopulationSize(100)
