...
import org.uma.jmetal.runner.multiobjective.PESA2Runner;
...
public class NSGAII_ASUBERunner extends ASUBERunner {

	public final String algName = "NSGA-II";
	
	//20200202_To use the output in the experiment process.
	public NSGAII_ASUBERunner() {
	...
	public void run(String problemClassName, int[] objs, String pName, String statemachinefile, String realbehaviorsfile, String referenceParetoFront) {
		...
		//Test in NSGAII_ASUBEProblemStudy.java
		...
		//It would be better to package the state machine and real behaviors to the former "vs" part.
		...
		System.out.println("Begin to set algorithm!");
	    ...
	    System.out.println("Begin to run algorithm!");
